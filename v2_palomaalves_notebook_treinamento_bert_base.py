# -*- coding: utf-8 -*-
"""v2_PalomaAlves_Notebook_Treinamento_BERT_base.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ybWaGyp6m2Sa_zmXRrAC-l7h3Q30tD8B

# Treinamento do BERT-Cased no Dataset Lener_br e Upload do Modelo para o Hugging Face
"""
...
!pip install datasets evaluate accelerate huggingface_hub seqeval
...
training_args = TrainingArguments(
    output_dir="./ner-bert-base-checkpoints",
    eval_strategy="epoch",
    save_strategy="epoch",
    learning_rate=2e-5,
    ...
    weight_decay=0.01,
    push_to_hub=True,
    hub_model_id="Palu1006/ner-bert-lenerbr-v2",
    hub_strategy="end",
    logging_dir="./logs",
    logging_steps=100,
