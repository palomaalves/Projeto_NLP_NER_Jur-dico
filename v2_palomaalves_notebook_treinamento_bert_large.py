# -*- coding: utf-8 -*-
"""v2_PalomaAlves_Notebook_Treinamento_BERT_large.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15a3VtvyHtBoJJX6MVt3nA6YPM1o2W9cG

# Treinamento do BERT-Cased no Dataset Lener_br e Upload do Modelo para o Hugging Face Utilizando o checkpoint neuralmind/bert-large-portuguese-cased
"""
...
# =============================================================================
# Alteração: Usar o checkpoint neuralmind/bert-large-portuguese-cased (BERTimbau Large)
...
training_args = TrainingArguments(
    output_dir="./ner-bert-large-checkpoints",
    eval_strategy="epoch",
    save_strategy="epoch",
    learning_rate=2e-5,
    ...
    weight_decay=0.01,
    push_to_hub=True,
    hub_model_id="Palu1006/ner-bert-large-v1",
    hub_strategy="end",
    logging_dir="./logs",
    logging_steps=100,
